...
public class BatchConfig {
  ...
  public FlatFileItemReader<IExamResult> reader() {
    ...
    reader.setResource(new ClassPathResource("com/nt/csv/intelligents.csv"));
  ...
  public JdbcBatchItemWriter<OExamResult> writer() {
    ...
    writer.setSql("INSERT INTO EXAM_RESULT1(ID,DOB,PERCENTAGE,SEMESTER)  VALUES (:id, :dob,:percentage,:sem)");
  ...
  @Bean("step1")
  public Step step1() {
    return stepBuilderFactory.get("step1").<IExamResult, OExamResult>chunk(1).reader(reader())
